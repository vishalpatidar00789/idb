...
import { ProfileSettingsComponent } from 'app/entities/profile-settings/profile-settings.component';
...
describe('Component Tests', () => {
    describe('ProfileSettings Management Component', () => {
        let comp: ProfileSettingsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProfileSettingsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.profileSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
