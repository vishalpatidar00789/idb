...
import { ChaptersComponent } from 'app/entities/chapters/chapters.component';
...
describe('Component Tests', () => {
    describe('Chapters Management Component', () => {
        let comp: ChaptersComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ChaptersComponent, '')
                .compileComponents();
