...
public class Photos implements Serializable {
    ...
    public Photos createdDate(LocalDate createdDate) {
    ...
    public Photos lastUpdatedDate(LocalDate lastUpdatedDate) {
    ...
    public Photos lastUpdatedBy(String lastUpdatedBy) {
    ...
    public Photos userProfile(UserProfile userProfile) {
