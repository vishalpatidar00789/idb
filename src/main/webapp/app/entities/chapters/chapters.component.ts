...
export class ChaptersComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.chaptersService
            ...
            .subscribe(
                (res: HttpResponse<IChapters[]>) => this.paginateChapters(res.body, res.headers),
    ...
    trackId(index: number, item: IChapters) {
        return item.id;
    }
    ...
    protected paginateChapters(data: IChapters[], headers: HttpHeaders) {
